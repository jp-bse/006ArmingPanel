/*
 * Weapon arming panel for HackPittsburgh's PPPRS car 2013
 * based on:
 ...
 * Heavily modified by Jay Pee for Hack Pittsburgh http://www.hackpittsburgh.org 2013
*/
...
void caltropCoverOpen() {
  caltropCover.write(90);
}
void caltropCoverClosed() {
  caltropCover.write(0);
}
